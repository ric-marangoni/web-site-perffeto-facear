<div class="horario-toolbar">
    <ul>
        <li class="add">
            <a href="javascript:void(0)" id="horario-incluir-tarde" name="horario-incluir">incluir horário</a>     
        </li>        
</div>

<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('#horario-incluir-tarde').click(function(){
            var trID = jQuery('#tarde tr').last().attr('id');
            trID = trID.split("-");
            trID = trID[1] * 1 + 1;
            ...
            jQuery('#tarde').append('\
                <tr id="tarde-'+trID+'">\
                    ...
                    <td class="atach-color" id="td-tarde-'+trID+'">\
                    ...
                    <td class="atach-color" id="td-tarde-'+trID+1+'">\
                    ...
                    <td class="atach-color" id="td-tarde-'+trID+2+'">\
                    ...
                    <td class="atach-color" id="td-tarde-'+trID+3+'">\
                    ...
                    <td class="atach-color" id="td-tarde-'+trID+4+'">\
                    ...
                    <td class="atach-color" id="td-tarde-'+trID+5+'">\
                    ...
                    <td class="ultimo">\
                        <input type="button" id="form-tarde-'+trID+'" class="btn-horario-gravar" value="gravar" />\
                    </td>\
                    <td class="no-show">\
                        <form name="form-tarde-'+trID+'">\
