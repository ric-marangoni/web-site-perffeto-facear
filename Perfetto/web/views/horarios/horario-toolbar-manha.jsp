        ...
        jQuery('#horario-incluir-manha').click(function(){
            ...
            jQuery('#manha').append('\
                <tr id="manha-'+trID+'">\
                    ...
                    <td class="atach-color" id="td-manha-'+trID+'">\
                    ...
                    <td class="atach-color" id="td-manha-'+trID+1+'">\
                    ...
                    <td class="atach-color" id="td-manha-'+trID+3+'">\
                    ...
                    <td class="atach-color" id="td-manha-'+trID+4+'">\
                    ...
                    <td class="atach-color" id="td-manha-'+trID+5+'">\
